...
execute_process(
  COMMAND "/sbin/git" --git-dir=.git show-ref "main"
  WORKING_DIRECTORY "/home/Jlisowskyy/storage/shit/io2/cmake-build-debug/_deps/libgtest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/Jlisowskyy/storage/shit/io2/cmake-build-debug/_deps/libgtest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/Jlisowskyy/storage/shit/io2/cmake-build-debug/_deps/libgtest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
